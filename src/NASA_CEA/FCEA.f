! il programma FCEA2.f é stato modificato per ottenere una automatizzazione del calcolo   
! delle proprietá di una miscela
!
! il programma é poi stato implementato in MATLAB per il calcolo dello scambio termico
!
! il programma prende automaticamente input RL10nozzlecase.inp
! 
! output del programma RL10nozzlecase.out && RL10nozzlecase.plt
! 
! modifiche effettuate al programma 
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!code line 132!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
C***********************************************************************
C            P R O G R A M      C E A    R L 1 0 - A 3 3 A
C
